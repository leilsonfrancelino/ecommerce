    ...
    var altera_quantidade_carrinho = function () {
        ...
        $('.btn-altera-quantidade').on('click', function () {
            ...
            if (produto_quantidade == "" || produto_quantidade < 1) {
                ...
                $('#mensagem').html('<div class="alert alert-success alert-dismissible fade show mt-2" role="alert"> Informe a quantidade maior que zero <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
