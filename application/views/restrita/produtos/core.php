				...
				<div class="card">
				  ...
				  <div class="card-body">
					...
					<div class="form-row">
					  ...
					  <legend class="custom-border">Dados do Produto</legend>
					  <div class="form-row">
					  ...
					  <div class="form-group col-md-2">
							  ...
							  <div class="form-group col-md-2">
								...
								<input type="text" name="produto_quantidade_estoque" class="form-control money" value="<?php echo (isset($produto) ? $produto->produto_quantidade_estoque : set_value('produto_quantidade_estoque')); ?>">
								<?php echo form_error('produto_quantidade_estoque', '<div class="text-danger">', '</div>'); ?>
							  </div> 
							   <div class="form-group col-md-2">
								<label>Controle de Estoque?</label>
								<select name="produto_controlar_estoque" class="form-control">
									<?php if(isset($produto)): ?>
					  ...
					  <div class="form-group col-md-3">
							...
							<select name="produto_marca_id" class="form-control">
							<option value="">Escolha...</option>
						  ...
						  <div class="form-group col-md-2">
							...
							<div class="form-group col-md-2">
								...
								<select name="produto_destaque" class="form-control">
									<?php if(isset($produto)): ?>
						...
						<fieldset class="custom-border">
							  <legend class="custom-border">Informações para o frete</legend>
						  <div class="form-row">							  
							  <div class="form-group col-md-3">
								<label class="required">Peso do Produto</label>
							  ...
							  <div class="form-group col-md-3">
								<label class="required">Altura do Produto</label>
							  ...
							  <div class="form-group col-md-3">
								<label class="required">Largura do Produto</label>
							  ...
							  <div class="form-group col-md-3">
								<label class="required">Comprimento do Produto</label>
