			  ...
			  <div class="col-12">
				<div class="card">
				  ...
				  <fieldset class="custom-border">
						  <legend class="custom-border">Dados pessoais</legend>
					<div class="form-row">
					...
					<fieldset class="custom-border">
						  <legend class="custom-border">Dados de login</legend>
					<div class="form-row">  
					...
					<fieldset class="custom-border">
						  <legend class="custom-border">Endereço</legend>
					  <div class="form-row"> 
					  <div class="form-group col-md-4">
				  ...
				  <div class="card-footer">
					...
					<a class="btn btn-dark" href="<?php echo base_url('restrita/clientes'); ?>">Voltar</a>
				  </div>	
