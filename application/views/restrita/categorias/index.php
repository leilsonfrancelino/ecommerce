                        ...
                        <tbody>
                          ...
                          <tr>						
                            ...
                            <td>
								...
								<a href="<?php echo base_url('restrita/categorias/delete/'.$categoria->categoria_id); ?>" class="btn btn-icon btn-danger delete" data-confirm="Tem certeza da exclusão?"><i class="fas fa-times"></i></a>
							</td>							
